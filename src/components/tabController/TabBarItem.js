...
import _cloneDeep from "lodash/cloneDeep"; // TODO: support commented props
...
export default function TabBarItem({
  ...
  return <GestureDetector gesture={gesture}>
      <Reanimated.View reanimated
    // @ts-expect-error
    ref={itemRef}
    // style={_style}
    style={animatedTabItemStyle} onLayout={onLayout} testID={testID}>
        {leadingAccessory}
